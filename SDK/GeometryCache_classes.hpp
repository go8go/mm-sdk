...
static_assert(sizeof(AGeometryCacheActor) == 0x000220, "Wrong size on AGeometryCacheActor");
static_assert(offsetof(AGeometryCacheActor, GeometryCacheComponent) == 0x000218, "Member 'AGeometryCacheActor::GeometryCacheComponent' has a wrong offset!");
