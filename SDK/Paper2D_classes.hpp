...
public:
	...
	UMulticastInlineDelegateProperty_             OnFinishedPlaying;                                 // 0x0478(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class UMaterialInterface*>             InstanceMaterials;                                 // 0x0440(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FSpriteInstanceData>            PerInstanceSpriteData;                             // 0x0450(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	struct FVector2D                              BakedSourceUV;                                     // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                              BakedSourceDimension;                              // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTexture2D*                             BakedSourceTexture;                                // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UMaterialInterface*                     AlternateMaterial;                                 // 0x0058(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FPaperSpriteSocket>             Sockets;                                           // 0x0060(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	ESpriteCollisionMode                          SpriteCollisionDomain;                             // 0x0070(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_71[0x3];                                       // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PixelsPerUnrealUnit;                               // 0x0074(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UBodySetup*                             BodySetup;                                         // 0x0078(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AlternateMaterialSplitIndex;                       // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_84[0x4];                                       // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVector4>                       BakedRenderData;                                   // 0x0088(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPaperSprite) == 0x000098, "Wrong size on UPaperSprite");
static_assert(offsetof(UPaperSprite, BakedSourceUV) == 0x000038, "Member 'UPaperSprite::BakedSourceUV' has a wrong offset!");
static_assert(offsetof(UPaperSprite, BakedSourceDimension) == 0x000040, "Member 'UPaperSprite::BakedSourceDimension' has a wrong offset!");
static_assert(offsetof(UPaperSprite, BakedSourceTexture) == 0x000048, "Member 'UPaperSprite::BakedSourceTexture' has a wrong offset!");
static_assert(offsetof(UPaperSprite, DefaultMaterial) == 0x000050, "Member 'UPaperSprite::DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UPaperSprite, AlternateMaterial) == 0x000058, "Member 'UPaperSprite::AlternateMaterial' has a wrong offset!");
static_assert(offsetof(UPaperSprite, Sockets) == 0x000060, "Member 'UPaperSprite::Sockets' has a wrong offset!");
static_assert(offsetof(UPaperSprite, SpriteCollisionDomain) == 0x000070, "Member 'UPaperSprite::SpriteCollisionDomain' has a wrong offset!");
static_assert(offsetof(UPaperSprite, PixelsPerUnrealUnit) == 0x000074, "Member 'UPaperSprite::PixelsPerUnrealUnit' has a wrong offset!");
static_assert(offsetof(UPaperSprite, BodySetup) == 0x000078, "Member 'UPaperSprite::BodySetup' has a wrong offset!");
static_assert(offsetof(UPaperSprite, AlternateMaterialSplitIndex) == 0x000080, "Member 'UPaperSprite::AlternateMaterialSplitIndex' has a wrong offset!");
static_assert(offsetof(UPaperSprite, BakedRenderData) == 0x000088, "Member 'UPaperSprite::BakedRenderData' has a wrong offset!");
...
public:
	...
	TArray<class UPaperTileLayer*>                TileLayers;                                        // 0x0460(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
