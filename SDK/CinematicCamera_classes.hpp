...
public:
	...
	struct FCameraLensSettings                    LensSettings;                                      // 0x0808(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0820(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	class FString                                 DefaultFilmbackPresetName;                         // 0x08B0(0x0010)(ZeroConstructor, Config, Deprecated, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 DefaultFilmbackPreset;                             // 0x08C0(0x0010)(ZeroConstructor, Config, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UCineCameraComponent, FilmbackSettings) == 0x0007F0, "Member 'UCineCameraComponent::FilmbackSettings' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, Filmback) == 0x0007FC, "Member 'UCineCameraComponent::Filmback' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, LensSettings) == 0x000808, "Member 'UCineCameraComponent::LensSettings' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FocusSettings) == 0x000820, "Member 'UCineCameraComponent::FocusSettings' has a wrong offset!");
...
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPreset) == 0x0008C0, "Member 'UCineCameraComponent::DefaultFilmbackPreset' has a wrong offset!");
