...
{
public:
	TArray<struct FSoundVariation>                Variations;                                        // 0x0160(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class USoundWave*                             SoundWave;                                         // 0x0170(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USoundSimple) == 0x000178, "Wrong size on USoundSimple");
static_assert(offsetof(USoundSimple, Variations) == 0x000160, "Member 'USoundSimple::Variations' has a wrong offset!");
static_assert(offsetof(USoundSimple, SoundWave) == 0x000170, "Member 'USoundSimple::SoundWave' has a wrong offset!");
