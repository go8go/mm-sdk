...
static_assert(sizeof(UImgMediaSource) == 0x0000B0, "Wrong size on UImgMediaSource");
static_assert(offsetof(UImgMediaSource, FrameRateOverride) == 0x000088, "Member 'UImgMediaSource::FrameRateOverride' has a wrong offset!");
static_assert(offsetof(UImgMediaSource, ProxyOverride) == 0x000090, "Member 'UImgMediaSource::ProxyOverride' has a wrong offset!");
static_assert(offsetof(UImgMediaSource, SequencePath) == 0x0000A0, "Member 'UImgMediaSource::SequencePath' has a wrong offset!");
