...
namespace Offsets
{
	constexpr int32 GObjects          = 0x06DF91F0;
	constexpr int32 AppendString      = 0x02344D80;
	constexpr int32 GNames            = 0x06DE1900;
	constexpr int32 GWorld            = 0x06EE0CD0;
	constexpr int32 ProcessEvent      = 0x024F5D60;
