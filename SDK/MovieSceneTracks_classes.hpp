...
public:
	...
	bool                                          bLooping;                                          // 0x0240(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSuppressSubtitles;                                // 0x0241(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAttenuation;                              // 0x0242(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x000240, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x000241, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x000242, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
...
// Class MovieSceneTracks.MovieSceneSkeletalAnimationOptimizedSection
// 0x0000 (0x00E0 - 0x00E0)
class UMovieSceneSkeletalAnimationOptimizedSection final : public UMovieSceneSection
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneSkeletalAnimationOptimizedSection">();
	}
	static class UMovieSceneSkeletalAnimationOptimizedSection* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneSkeletalAnimationOptimizedSection>();
	}
};
static_assert(alignof(UMovieSceneSkeletalAnimationOptimizedSection) == 0x000008, "Wrong alignment on UMovieSceneSkeletalAnimationOptimizedSection");
static_assert(sizeof(UMovieSceneSkeletalAnimationOptimizedSection) == 0x0000E0, "Wrong size on UMovieSceneSkeletalAnimationOptimizedSection");
...
public:
	...
	class UMovieSceneSkeletalAnimationOptimizedSection* AnimationOptimizedSection;                         // 0x0068(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneSkeletalAnimationTrack, AnimationOptimizedSection) == 0x000068, "Member 'UMovieSceneSkeletalAnimationTrack::AnimationOptimizedSection' has a wrong offset!");
