...
// TSubclassOf<class UNavigationQueryFilter>QueryFilterClass                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAIBlueprintHelperLibrary::SimpleMoveToActor(class AController* Controller, const class AActor* Goal, TSubclassOf<class UNavigationQueryFilter> QueryFilterClass)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Controller = Controller;
	Parms.Goal = Goal;
	Parms.QueryFilterClass = QueryFilterClass;
...
void UAIBlueprintHelperLibrary::SimpleMoveToLocation(class AController* Controller, const struct FVector& Goal, TSubclassOf<class UNavigationQueryFilter> QueryFilterClass)
{
	static class UFunction* Func = nullptr;
