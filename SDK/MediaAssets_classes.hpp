...
public:
	...
	struct FFloatRange                            RateAdjustmentRange;                               // 0x065C(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_678[0x1E8];                                    // 0x0678(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaSoundComponent) == 0x000860, "Wrong size on UMediaSoundComponent");
