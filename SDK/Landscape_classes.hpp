...
public:
	...
	TArray<struct FLandscapeComponentMaterialOverride> OverrideMaterials;                                 // 0x0440(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceConstant*>      MaterialInstances;                                 // 0x0450(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceDynamic*>       MaterialInstancesDynamic;                          // 0x0460(0x0010)(ZeroConstructor, Transient, TextExportTransient, NativeAccessSpecifierPublic)
	TArray<int8>                                  LODIndexToMaterialIndex;                           // 0x0470(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	TArray<int8>                                  MaterialIndexToDisabledTessellationMaterial;       // 0x0480(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	...
	TArray<struct FWeightmapLayerAllocationInfo>  WeightmapLayerAllocations;                         // 0x0510(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UTexture2D*>                     WeightmapTextures;                                 // 0x0520(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPrivate)
	...
	TArray<struct FGuid>                          IrrelevantLights;                                  // 0x0540(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	...
	TArray<class UMaterialInterface*>             MobileMaterialInterfaces;                          // 0x05A8(0x0010)(ZeroConstructor, NonPIEDuplicateTransient, NativeAccessSpecifierPublic)
	TArray<class UTexture2D*>                     MobileWeightmapTextures;                           // 0x05B8(0x0010)(ZeroConstructor, NonPIEDuplicateTransient, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>      ComponentLayerInfos;                               // 0x0418(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<uint8>                                 CollisionQuadFlags;                                // 0x0440(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<class UPhysicalMaterial*>              CookedPhysicalMaterials;                           // 0x04A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FIntPoint>                      ProxyComponentBases;                               // 0x04B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>   ControlPoints;                                     // 0x0418(0x0010)(ZeroConstructor, Protected, TextExportTransient, NativeAccessSpecifierProtected)
	TArray<class ULandscapeSplineSegment*>        Segments;                                          // 0x0428(0x0010)(ZeroConstructor, Protected, TextExportTransient, NativeAccessSpecifierProtected)
	TArray<class UMeshComponent*>                 CookedForeignMeshComponents;                       // 0x0438(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, TextExportTransient, NativeAccessSpecifierProtected)
