...
// Function UMG.RetainerBox.SetZCompareValue
// 0x0004 (0x0004 - 0x0000)
struct RetainerBox_SetZCompareValue final
{
public:
...
static_assert(alignof(RetainerBox_SetZCompareValue) == 0x000004, "Wrong alignment on RetainerBox_SetZCompareValue");
static_assert(sizeof(RetainerBox_SetZCompareValue) == 0x000004, "Wrong size on RetainerBox_SetZCompareValue");
static_assert(offsetof(RetainerBox_SetZCompareValue, Zvalue) == 0x000000, "Member 'RetainerBox_SetZCompareValue::Zvalue' has a wrong offset!");
