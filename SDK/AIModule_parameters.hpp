...
public:
	...
	TSubclassOf<class UNavigationQueryFilter>     QueryFilterClass;                                  // 0x0010(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AIBlueprintHelperLibrary_SimpleMoveToActor) == 0x000018, "Wrong size on AIBlueprintHelperLibrary_SimpleMoveToActor");
...
static_assert(offsetof(AIBlueprintHelperLibrary_SimpleMoveToActor, QueryFilterClass) == 0x000010, "Member 'AIBlueprintHelperLibrary_SimpleMoveToActor::QueryFilterClass' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UNavigationQueryFilter>     QueryFilterClass;                                  // 0x0018(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(AIBlueprintHelperLibrary_SimpleMoveToLocation, QueryFilterClass) == 0x000018, "Member 'AIBlueprintHelperLibrary_SimpleMoveToLocation::QueryFilterClass' has a wrong offset!");
