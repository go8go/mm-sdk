...
// ScriptStruct MovieSceneTracks.MovieSceneSkeletalAnimationOptimizedSectionTemplate
// 0x0050 (0x0070 - 0x0020)
struct FMovieSceneSkeletalAnimationOptimizedSectionTemplate final : public FMovieSceneEvalTemplate
{
public:
	uint8                                         Pad_20[0x50];                                      // 0x0020(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieSceneSkeletalAnimationOptimizedSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneSkeletalAnimationOptimizedSectionTemplate");
static_assert(sizeof(FMovieSceneSkeletalAnimationOptimizedSectionTemplate) == 0x000070, "Wrong size on FMovieSceneSkeletalAnimationOptimizedSectionTemplate");
...
static_assert(sizeof(FMovieSceneEventPtrs) == 0x000010, "Wrong size on FMovieSceneEventPtrs");
...
static_assert(sizeof(FMovieSceneEvent) == 0x000010, "Wrong size on FMovieSceneEvent");
